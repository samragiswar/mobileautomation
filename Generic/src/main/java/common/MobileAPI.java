    ...
    public void setUp(String OS,String appType,String deviceType,String deviceName,
        ...
        if(OS.equalsIgnoreCase("ios")){
            ...
            if(appType.contains("Phone")){
                ...
                findApp = new File("/Users/bibeksingh/Downloads/mobileautomation/FACEBOOK/src/app/nyp-v3.apk");
                if(deviceType.equalsIgnoreCase("RealDevice")){
                    cap = new DesiredCapabilities();
                    cap.setCapability(MobileCapabilityType.DEVICE_NAME,deviceName);
                    ...
                    cap.setCapability(MobileCapabilityType.PLATFORM_VERSION, version);
                    cap.setCapability(MobileCapabilityType.APP, findApp.getAbsolutePath());
                    cap.setCapability(MobileCapabilityType.APP_ACTIVITY, "com.wizeline.nypost.ui.collections.NYPCollectionActivity");
                    cap.setCapability(MobileCapabilityType.APP_PACKAGE, "br.com.golmobile.nypost");
                    ad = new AndroidDriver(new URL("http://127.0.0.1:4723/wd/hub"), cap);
